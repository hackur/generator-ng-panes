...
var Generator = module.exports = function()
{
    ...
    // for constant
    this.upperedName = us.underscored( human1 ).toUpperCase();
    ...
    */
    ...
    // flag for directive only - to create a slim directive that has no templates
    this.option('slim' , {
        type: String,
        desc: 'Create a slim down directive restircted to Attribute level without templates',
        alias: 'sd'
    })
...
/**
 * need to fix the path for template when its in windows environemnt
 * 2016-05-31 finally fix this problem with the split path 
 */
Generator.prototype.fixPath = function(p)
{
